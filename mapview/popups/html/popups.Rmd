...
All major image types are supported (`jpg`, `png`, `svg` and (animated) `gif`)
...
pt4 <- data.frame(x = jitter(rep(174.764474, 4), factor = 0.001),
                  y = jitter(rep(-36.877245, 4), factor = 0.001))
coordinates(pt4) <- ~ x + y
